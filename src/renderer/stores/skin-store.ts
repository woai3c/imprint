...
export const builtinThemes: AppTheme[] = [
  ...
  },
  {
    ...
    colors: {
      ...
      foreground: 'oklch(18% 0.01 60)',
      primary: 'oklch(30% 0.02 50)',
      'primary-foreground': 'oklch(96% 0.003 90)',
      secondary: 'oklch(91% 0.005 85)',
      'secondary-foreground': 'oklch(25% 0.01 50)',
      muted: 'oklch(92% 0.004 85)',
      'muted-foreground': 'oklch(42% 0.01 60)',
      accent: 'oklch(48% 0.16 25)',
      'accent-foreground': 'oklch(96% 0 0)',
      card: 'oklch(97% 0.002 85)',
      'card-foreground': 'oklch(18% 0.01 60)',
      border: 'oklch(82% 0.008 70)',
      ring: 'oklch(30% 0.02 50)',
      sidebar: 'oklch(94% 0.004 80)',
      'sidebar-foreground': 'oklch(22% 0.01 55)',
      'sidebar-accent': 'oklch(88% 0.01 70)',
    },
    radius: '0.125rem',
    fontFamily: '"Noto Serif SC", "Source Han Serif SC", "LXGW WenKai", serif',
  },
  {
    id: 'cyberpunk',
    name: '赛博朋克',
