...
evidence, not manual tuning surfaces: do not edit their CSS or declared expectations after inspecting a benchmark
result. A scenario used to change comparison behavior must move to regression coverage.
